  ...
  return (
    <AppLayout>
      ...
      <div className="card" style={{ padding: 24, maxWidth: 480 }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', fontWeight: 700, fontSize: 17, marginTop: 6 }}>
          <span>Total</span>
      ...
      <div style={{ display: 'flex', gap: 10, marginTop: 16, maxWidth: 480 }}>
        <button onClick={() => navigate('/transaksi')} style={{ flex: 1, padding: 10 }}>
          Kembali
        </button>
        <button
